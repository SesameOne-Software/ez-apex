...
#define xorstr(str) []{ constexpr crypt::Xor_string<(sizeof(str)/sizeof(char)), char> expr(str); return expr; }().decrypt()
#define xorstrw(str) []{ constexpr crypt::Xor_string<(sizeof(str)/sizeof(wchar_t)), wchar_t> expr(str); return expr; }().decrypt()