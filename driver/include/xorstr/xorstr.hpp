...
#define _(str) []{ constexpr crypt::Xor_string<(sizeof(str)/sizeof(char)), char> expr(str); return expr; }().decrypt()
#define _w(str) []{ constexpr crypt::Xor_string<(sizeof(str)/sizeof(wchar_t)), wchar_t> expr(str); return expr; }().decrypt()